defmodule AdventOfCode.Y2024.Day01 do
  ...
  """
  use AdventOfCode.Helpers.InputReader, year: 2024, day: 1
  ...
  *`2`*.
  ...
  the similarity score again increases by 9. So, for these example lists, the
  ...
  def solve_2(data) do
    ...
    for id <- left, reduce: 0 do
      acc -> acc + Map.get(freqs, id, 0) * id
    end
  end

  # --- </Solution Functions> ---
  defp left_right(data) do
    data
