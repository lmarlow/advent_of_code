defmodule AdventOfCode.Y2025.Day12 do
  ...
  """
  use AdventOfCode.Helpers.InputReader, year: 2025, day: 12
  ...
  they're worried about is the *presents* for all the young Elves that
  live here at the North Pole. It's an ancient tradition to put the
  ...
  *units*. To be aesthetically pleasing, the presents need to be placed
  ...
  together (that is, the `.` part in a present's shape's diagram does not
